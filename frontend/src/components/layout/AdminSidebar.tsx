...
export default function AdminSidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 flex h-screen w-[72px] flex-col border-r border-white/10 bg-[#080706] text-white xl:w-60">
      <div className="flex min-h-0 flex-1 flex-col px-2 py-5 xl:px-3">
        <div className="mb-5 shrink-0 px-1 xl:px-2">
          ...
          <p className="hidden text-[10px] uppercase tracking-widest text-white/50 xl:block">{t("adminPanel")}</p>
        ...
        <nav className="custom-scrollbar min-h-0 flex-1 space-y-5 overflow-y-auto pr-0.5" aria-label="Admin navigation">
          <div>
            ...
            >
              ...
              <span className="hidden truncate text-sm font-medium xl:inline">{t("overview")}</span>
            </Link>
          </div>
                  ...
                  return (
                    <li key={item.href}>
                      ...
                      >
                        ...
                        <span className="hidden truncate text-sm font-medium xl:inline">{label}</span>
                      </Link>
                    </li>
                  );
                })}
        ...
        <div className="mt-3 shrink-0 space-y-2 border-t border-white/10 pt-4">
          ...
          <div className="hidden items-center gap-2 px-2 xl:flex">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[10px] uppercase tracking-wider text-white/40">{tRoles("admin")}</p>
            </div>
          </div>
          <button
            type="button"
          ...
          >
            ...
            <span className="hidden text-sm xl:inline">{tCommon("logout")}</span>
          </button>
        </div>
      </div>
    </aside>
