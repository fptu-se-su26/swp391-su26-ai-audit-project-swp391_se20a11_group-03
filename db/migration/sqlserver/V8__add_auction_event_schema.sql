...
-- =====================================================
-- V8__add_auction_event_schema.sql: Add Auction Event module tables and Product.IsLockedInEvent column
-- =====================================================
USE SWP_Nhom3_App;
GO

-- Add IsLockedInEvent column to Products table
...
PRINT 'Tables added: AuctionEvents, EventProducts, EventRegistrations, SealedBids, PennyBids';
PRINT 'Column added: Products.IsLockedInEvent';
GO
