    ...
    <div class="shell">
        <div class="hero">
            ...
            <aside class="right" aria-hidden="true">
                <div class="art">
                    <img alt="Luxury Auction" src="https://lh3.googleusercontent.com/aida-public/AB6AXuA0_QH_jlR5knRFMIzliDGgOx7IevRtXO86U-bV1eC5yp0vN_mU8rMMBu6rp0xfOvOMnLLTNAmmeyZ-Hgn2KzXRgr32O4Mk6STYqCaN8-GXPmB2YFM1FqTInWHyrJ3IbzP7bPcNb18zk62zl8Mv-CILX_75WIJQRWBTrpVi2nm84LoTk-1sVdi5O6kudZF1oj9AJ83P3zGe8HD97zTlepjT9XoyscVPA6dprYAId1yy95lPDzU_uee4r7_8tW4Umvw-fL7ZI15STdLl" />
                    <div class="gradient-overlay"></div>
                    <div class="art-content">
                        <div class="badge">Secure Sign-up</div>
                        <div>
                            <div class="quote">Create your account.</div>
                            <div class="foot">Join the auction platform in a premium style.</div>
                        </div>
                    </div>
                </div>
            </aside>
