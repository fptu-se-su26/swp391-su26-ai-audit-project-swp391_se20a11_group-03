...
const faqs = [
  ...
  ["storefront", "Bán cùng BidZone", "Đăng ký seller, định giá và phí dịch vụ."],
  ["security", "Tài khoản & bảo mật", "2FA, xác minh danh tính và bảo vệ tài khoản."],
];

export default function SupportPage() {
  const [query, setQuery] = useState("");
  return <DashboardLayout><div className="mx-auto max-w-[1260px] px-4 py-10 sm:px-7 lg:px-10 lg:py-14"><DashboardHeader eyebrow="Private client care" title="Trung tâm hỗ trợ" subtitle="Nhận câu trả lời nhanh hoặc kết nối với Auction Concierge của BidZone."/>
