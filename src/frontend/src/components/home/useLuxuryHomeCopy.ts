...
const copy = {
  vi: {
    ...
    noFeatured: "Chưa có phiên đấu giá trực tiếp", noFeaturedDesc: "Khi có sản phẩm được duyệt và lên phiên, chúng sẽ hiển thị tại đây.", sellCta: "Đăng bán sản phẩm",
    noUpcoming: "Chưa có phiên sắp diễn ra", noResults: "Chưa có kết quả đấu giá",
  ...
  en: {
    ...
    noFeatured: "No live auctions yet", noFeaturedDesc: "Approved lots will appear here once they go live.", sellCta: "List an item",
    noUpcoming: "No upcoming auctions", noResults: "No auction results yet",
