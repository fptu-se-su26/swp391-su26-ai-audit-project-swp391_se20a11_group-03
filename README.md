...
```text
backend/       Spring Boot API, database resources, and backend tests
...
```text
backend/src/main/resources/db/create-database.sql
```

Default JDBC settings are in `backend/src/main/resources/application.properties`:
